...
def get_crypto_dsc(options, functions):
    ...
    lines = ["########################################",
             "# AUTOGENERATED BY " + REL_PATH,
             "# DO NOT MODIFY"]
    lines.append("# GENERATED ON: " + str(datetime.datetime.now()))
    lines.append("")
    ...
    output_path = os.path.join(options.out_dir, "Crypto.inc.dsc")
...
def get_crypto_h(options, functions):
    ...
    lines.append("// AUTOGEN ENDS")
    lines.append(
        "// ****************************************************************************")

    output_path = os.path.join(options.out_dir, "temp_Crypto.h")
    out_file = open(output_path, "w")
    out_file.write("\n".join(lines))
    out_file.close()
    if options.verbose:
...
def get_crypto_pcds(options, functions):
    ...
    lines.append("## AUTOGEN ENDS")
    lines.append("## ****************************************************************************")
    output_path = os.path.join(options.out_dir, "temp_crypto_pcd.inc.dec")
    out_file = open(output_path, "w")
    out_file.write("\n".join(lines))
    out_file.close()
    if options.verbose:
...
def get_crypto_inf(options, functions):
    ...
    lines.append("## AUTOGEN ENDS")
    lines.append("## ****************************************************************************")
    output_path = os.path.join(options.out_dir, "temp_crypto_pcd.inc.inf")
    out_file = open(output_path, "w")
    out_file.write("\n".join(lines))
    out_file.close()
    if options.verbose:
