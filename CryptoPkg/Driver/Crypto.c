...
// DO NOT MODIFY
// GENERATED ON: 2020-03-27 15:34:12.357119
...
**/
// See BaseCryptLib.h:1039
VOID *
CryptoServiceHmacMd5New (
    VOID
  )
{
  return CALL_BASECRYPTLIB (HmacMd5New, (), NULL);
}
/**
...
**/
// See BaseCryptLib.h:1053
VOID
CryptoServiceHmacMd5Free (
    IN  VOID  *HmacMd5Ctx
  )
{
  CALL_VOID_BASECRYPTLIB (HmacMd5Free, (HmacMd5Ctx));
}
/**
...
{
  return CALL_BASECRYPTLIB (HmacMd5SetKey, (HmacMd5Context, Key, KeySize), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (HmacMd5Duplicate, (HmacMd5Context, NewHmacMd5Context), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (HmacMd5Update, (HmacMd5Context, Data, DataSize), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (HmacMd5Final, (HmacMd5Context, HmacValue), FALSE);
}
//=============================================================================
//     HMACSHA1 functions
//=============================================================================
...
**/
// See BaseCryptLib.h:1172
VOID *
CryptoServiceHmacSha1New (
    VOID
  )
{
  return CALL_BASECRYPTLIB (HmacSha1New, (), NULL);
}
/**
  Release the specified HMAC_CTX context.
  If this interface is not supported, then do nothing.
...
**/
// See BaseCryptLib.h:1186
VOID
CryptoServiceHmacSha1Free (
    IN  VOID  *HmacSha1Ctx
  )
{
  CALL_VOID_BASECRYPTLIB (HmacSha1Free, (HmacSha1Ctx));
}
/**
  Set user-supplied key for subsequent use. It must be done before any
...
{
  return CALL_BASECRYPTLIB (HmacSha1SetKey, (HmacSha1Context, Key, KeySize), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (HmacSha1Duplicate, (HmacSha1Context, NewHmacSha1Context), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (HmacSha1Update, (HmacSha1Context, Data, DataSize), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (HmacSha1Final, (HmacSha1Context, HmacValue), FALSE);
}
//=============================================================================
...
**/
// See BaseCryptLib.h:1302
VOID *
CryptoServiceHmacSha256New (
    VOID
  )
{
  return CALL_BASECRYPTLIB (HmacSha256New, (), NULL);
}
/**
  Release the specified HMAC_CTX context.
  @param[in]  HmacSha256Ctx  Pointer to the HMAC_CTX context to be released.
**/
// See BaseCryptLib.h:1314
VOID
CryptoServiceHmacSha256Free (
    IN  VOID  *HmacSha256Ctx
  )
{
  CALL_VOID_BASECRYPTLIB (HmacSha256Free, (HmacSha256Ctx));
}
/**
  Set user-supplied key for subsequent use. It must be done before any
...
{
  return CALL_BASECRYPTLIB (HmacSha256SetKey, (HmacSha256Context, Key, KeySize), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (HmacSha256Duplicate, (HmacSha256Context, NewHmacSha256Context), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (HmacSha256Update, (HmacSha256Context, Data, DataSize), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (HmacSha256Final, (HmacSha256Context, HmacValue), FALSE);
}
//=============================================================================
//     MD4 functions
//=============================================================================
...
**/
// See BaseCryptLib.h:90
UINTN
CryptoServiceMd4GetContextSize (
    VOID
  )
{
  return CALL_BASECRYPTLIB (Md4GetContextSize, (), 0);
}
/**
  ...
  @retval FALSE  This interface is not supported.
**/
// See BaseCryptLib.h:110
BOOLEAN
CryptoServiceMd4Init (
    OUT  VOID  *Md4Context
  )
{
  return CALL_BASECRYPTLIB (Md4Init, (Md4Context), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (Md4Duplicate, (Md4Context, NewMd4Context), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (Md4Update, (Md4Context, Data, DataSize), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (Md4Final, (Md4Context, HashValue), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (Md4HashAll, (Data, DataSize, HashValue), FALSE);
}
//=============================================================================
//     MD5 functions
//=============================================================================
/**
  ...
  @retval  0   This interface is not supported.
**/
// See BaseCryptLib.h:230
UINTN
CryptoServiceMd5GetContextSize (
    VOID
  )
{
  return CALL_BASECRYPTLIB (Md5GetContextSize, (), 0);
}
/**
  ...
  @retval FALSE  This interface is not supported.
**/
// See BaseCryptLib.h:250
BOOLEAN
CryptoServiceMd5Init (
    OUT  VOID  *Md5Context
  )
{
  return CALL_BASECRYPTLIB (Md5Init, (Md5Context), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (Md5Duplicate, (Md5Context, NewMd5Context), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (Md5Update, (Md5Context, Data, DataSize), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (Md5Final, (Md5Context, HashValue), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (Md5HashAll, (Data, DataSize, HashValue), FALSE);
}
//=============================================================================
//     PKCS functions
//=============================================================================
...
{
  return CALL_BASECRYPTLIB (Pkcs5HashPassword, (PasswordLength, Password, SaltLength, Salt, IterationCount, DigestSize, KeyLength, OutKey), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (Pkcs1v2Encrypt, (PublicKey, PublicKeySize, InData, InDataSize, PrngSeed, PrngSeedSize, EncryptedData, EncryptedDataSize), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (Pkcs7GetSigners, (P7Data, P7Length, CertStack, StackLength, TrustedCert, CertLength), FALSE);
}
/**
...
**/
// See BaseCryptLib.h:2637
VOID
CryptoServicePkcs7FreeSigners (
    IN  UINT8        *Certs
  )
{
  CALL_VOID_BASECRYPTLIB (Pkcs7FreeSigners, (Certs));
}
/**
...
{
  return CALL_BASECRYPTLIB (Pkcs7GetCertificatesList, (P7Data, P7Length, SignerChainCerts, ChainLength, UnchainCerts, UnchainLength), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (Pkcs7Sign, (PrivateKey, PrivateKeySize, KeyPassword, InData, InDataSize, SignCert, OtherCerts, SignedData, SignedDataSize), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (Pkcs7Verify, (P7Data, P7Length, TrustedCert, CertLength, InData, DataLength), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (VerifyEKUsInPkcs7Signature, (Pkcs7Signature, SignatureSize, RequiredEKUs, RequiredEKUsSize, RequireAllPresent), 0);
}
/**
...
{
  return CALL_BASECRYPTLIB (Pkcs7GetAttachedContent, (P7Data, P7Length, Content, ContentSize), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (AuthenticodeVerify, (AuthData, DataSize, TrustedCert, CertSize, ImageHash, HashSize), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (ImageTimestampVerify, (AuthData, DataSize, TsaCert, CertSize, SigningTime), FALSE);
}
//=============================================================================
//     DH functions
//=============================================================================
...
{
  return CALL_BASECRYPTLIB (DhNew, (), NULL);
}
/**
...
{
  CALL_VOID_BASECRYPTLIB (DhFree, (DhContext));
}
/**
...
{
  return CALL_BASECRYPTLIB (DhGenerateParameter, (DhContext, Generator, PrimeLength, Prime), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (DhSetParameter, (DhContext, Generator, PrimeLength, Prime), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (DhGenerateKey, (DhContext, PublicKey, PublicKeySize), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (DhComputeKey, (DhContext, PeerPublicKey, PeerPublicKeySize, Key, KeySize), FALSE);
}
//=============================================================================
//     RANDOM functions
//=============================================================================
...
{
  return CALL_BASECRYPTLIB (RandomSeed, (Seed, SeedSize), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (RandomBytes, (Output, Size), FALSE);
}
//=============================================================================
//     RSA functions
//=============================================================================
...
**/
// See BaseCryptLib.h:1959
VOID *
CryptoServiceRsaNew (
    VOID
  )
{
  return CALL_BASECRYPTLIB (RsaNew, (), NULL);
}
/**
...
**/
// See BaseCryptLib.h:1973
VOID
CryptoServiceRsaFree (
    IN  VOID  *RsaContext
  )
{
  CALL_VOID_BASECRYPTLIB (RsaFree, (RsaContext));
}
/**
...
{
  return CALL_BASECRYPTLIB (RsaSetKey, (RsaContext, KeyTag, BigNumber, BnSize), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (RsaGetKey, (RsaContext, KeyTag, BigNumber, BnSize), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (RsaGenerateKey, (RsaContext, ModulusLength, PublicExponent, PublicExponentSize), FALSE);
}
/**
  ...
  @retval  FALSE  This interface is not supported.
**/
// See BaseCryptLib.h:2100
BOOLEAN
CryptoServiceRsaCheckKey (
    IN  VOID  *RsaContext
  )
{
  return CALL_BASECRYPTLIB (RsaCheckKey, (RsaContext), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (RsaPkcs1Sign, (RsaContext, MessageHash, HashSize, Signature, SigSize), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (RsaPkcs1Verify, (RsaContext, MessageHash, HashSize, Signature, SigSize), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (RsaGetPrivateKeyFromPem, (PemData, PemSize, Password, RsaContext), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (RsaGetPublicKeyFromX509, (Cert, CertSize, RsaContext), FALSE);
}
//=============================================================================
//     SHA1 functions
//=============================================================================
/**
  ...
  @retval  0   This interface is not supported.
**/
// See BaseCryptLib.h:370
UINTN
CryptoServiceSha1GetContextSize (
    VOID
  )
{
  return CALL_BASECRYPTLIB (Sha1GetContextSize, (), 0);
}
/**
  ...
  @retval FALSE  This interface is not supported.
**/
// See BaseCryptLib.h:390
BOOLEAN
CryptoServiceSha1Init (
    OUT  VOID  *Sha1Context
  )
{
  return CALL_BASECRYPTLIB (Sha1Init, (Sha1Context), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (Sha1Duplicate, (Sha1Context, NewSha1Context), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (Sha1Update, (Sha1Context, Data, DataSize), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (Sha1Final, (Sha1Context, HashValue), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (Sha1HashAll, (Data, DataSize, HashValue), FALSE);
}
//=============================================================================
//     SHA256 functions
//=============================================================================
...
**/
// See BaseCryptLib.h:507
UINTN
CryptoServiceSha256GetContextSize (
    VOID
  )
{
  return CALL_BASECRYPTLIB (Sha256GetContextSize, (), 0);
}
/**
...
**/
// See BaseCryptLib.h:525
BOOLEAN
CryptoServiceSha256Init (
    OUT  VOID  *Sha256Context
  )
{
  return CALL_BASECRYPTLIB (Sha256Init, (Sha256Context), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (Sha256Duplicate, (Sha256Context, NewSha256Context), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (Sha256Update, (Sha256Context, Data, DataSize), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (Sha256Final, (Sha256Context, HashValue), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (Sha256HashAll, (Data, DataSize, HashValue), FALSE);
}
//=============================================================================
//     SHA384 functions
//=============================================================================
...
**/
// See BaseCryptLib.h:638
UINTN
CryptoServiceSha384GetContextSize (
    VOID
  )
{
  return CALL_BASECRYPTLIB (Sha384GetContextSize, (), 0);
}
/**
...
**/
// See BaseCryptLib.h:656
BOOLEAN
CryptoServiceSha384Init (
    OUT  VOID  *Sha384Context
  )
{
  return CALL_BASECRYPTLIB (Sha384Init, (Sha384Context), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (Sha384Duplicate, (Sha384Context, NewSha384Context), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (Sha384Update, (Sha384Context, Data, DataSize), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (Sha384Final, (Sha384Context, HashValue), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (Sha384HashAll, (Data, DataSize, HashValue), FALSE);
}
//=============================================================================
//     SHA512 functions
//=============================================================================
...
**/
// See BaseCryptLib.h:769
UINTN
CryptoServiceSha512GetContextSize (
    VOID
  )
{
  return CALL_BASECRYPTLIB (Sha512GetContextSize, (), 0);
}
/**
...
{
  return CALL_BASECRYPTLIB (Sha512Init, (Sha512Context), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (Sha512Duplicate, (Sha512Context, NewSha512Context), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (Sha512Update, (Sha512Context, Data, DataSize), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (Sha512Final, (Sha512Context, HashValue), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (Sha512HashAll, (Data, DataSize, HashValue), FALSE);
}
//=============================================================================
//     X509 functions
//=============================================================================
...
{
  return CALL_BASECRYPTLIB (X509GetSubjectName, (Cert, CertSize, CertSubject, SubjectSize), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (X509GetCommonName, (Cert, CertSize, CommonName, CommonNameSize), 0);
}
/**
...
{
  return CALL_BASECRYPTLIB (X509GetOrganizationName, (Cert, CertSize, NameBuffer, NameBufferSize), 0);
}
/**
...
{
  return CALL_BASECRYPTLIB (X509VerifyCert, (Cert, CertSize, CACert, CACertSize), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (X509ConstructCertificate, (Cert, CertSize, SingleX509Cert), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (X509ConstructCertificateStackV, (X509Stack, Args), FALSE);
}
/**
  Construct a X509 stack object from a list of DER-encoded certificate data.
  If X509Stack is NULL, then return FALSE.
...
{
  CALL_VOID_BASECRYPTLIB (X509Free, (X509Cert));
}
/**
...
{
  CALL_VOID_BASECRYPTLIB (X509StackFree, (X509Stack));
}
/**
...
{
  return CALL_BASECRYPTLIB (X509GetTBSCert, (Cert, CertSize, TBSCert, TBSCertSize), FALSE);
}
//=============================================================================
//     TDES functions
//=============================================================================
/**
  ...
  @retval  0   This interface is not supported.
**/
// See BaseCryptLib.h:1436
UINTN
CryptoServiceTdesGetContextSize (
    VOID
  )
{
  return CALL_BASECRYPTLIB (TdesGetContextSize, (), 0);
}
/**
...
{
  return CALL_BASECRYPTLIB (TdesInit, (TdesContext, Key, KeyLength), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (TdesEcbEncrypt, (TdesContext, Input, InputSize, Output), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (TdesEcbDecrypt, (TdesContext, Input, InputSize, Output), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (TdesCbcEncrypt, (TdesContext, Input, InputSize, Ivec, Output), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (TdesCbcDecrypt, (TdesContext, Input, InputSize, Ivec, Output), FALSE);
}
//=============================================================================
//     AES functions
//=============================================================================
/**
  ...
  @retval  0   This interface is not supported.
**/
// See BaseCryptLib.h:1632
UINTN
CryptoServiceAesGetContextSize (
    VOID
  )
{
  return CALL_BASECRYPTLIB (AesGetContextSize, (), 0);
}
/**
...
{
  return CALL_BASECRYPTLIB (AesInit, (AesContext, Key, KeyLength), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (AesEcbEncrypt, (AesContext, Input, InputSize, Output), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (AesEcbDecrypt, (AesContext, Input, InputSize, Output), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (AesCbcEncrypt, (AesContext, Input, InputSize, Ivec, Output), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (AesCbcDecrypt, (AesContext, Input, InputSize, Ivec, Output), FALSE);
}
//=============================================================================
//     ARC4 functions
//=============================================================================
/**
  ...
  @retval  0   This interface is not supported.
**/
// See BaseCryptLib.h:1825
UINTN
CryptoServiceArc4GetContextSize (
    VOID
  )
{
  return CALL_BASECRYPTLIB (Arc4GetContextSize, (), 0);
}
/**
...
{
  return CALL_BASECRYPTLIB (Arc4Init, (Arc4Context, Key, KeySize), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (Arc4Encrypt, (Arc4Context, Input, InputSize, Output), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (Arc4Decrypt, (Arc4Context, Input, InputSize, Output), FALSE);
}
/**
  ...
  @retval FALSE  This interface is not supported.
**/
// See BaseCryptLib.h:1942
BOOLEAN
CryptoServiceArc4Reset (
    IN OUT  VOID  *Arc4Context
  )
{
  return CALL_BASECRYPTLIB (Arc4Reset, (Arc4Context), FALSE);
}
//=============================================================================
//     SM3 functions
//=============================================================================
...
**/
// See BaseCryptLib.h:900
UINTN
CryptoServiceSm3GetContextSize (
    VOID
  )
{
  return CALL_BASECRYPTLIB (Sm3GetContextSize, (), 0);
}
/**
...
{
  return CALL_BASECRYPTLIB (Sm3Init, (Sm3Context), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (Sm3Duplicate, (Sm3Context, NewSm3Context), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (Sm3Update, (Sm3Context, Data, DataSize), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (Sm3Final, (Sm3Context, HashValue), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (Sm3HashAll, (Data, DataSize, HashValue), FALSE);
}
//=============================================================================
//     HKDF functions
//=============================================================================
...
{
  return CALL_BASECRYPTLIB (HkdfSha256ExtractAndExpand, (Key, KeySize, Salt, SaltSize, Info, InfoSize, Out, OutSize), FALSE);
}
//=============================================================================
//     TLS functions
//=============================================================================
...
{
  return CALL_BASECRYPTLIB (TlsInitialize, (), FALSE);
}
/**
...
{
  CALL_VOID_BASECRYPTLIB (TlsCtxFree, (TlsCtx));
}
/**
...
{
  return CALL_BASECRYPTLIB (TlsCtxNew, (MajorVer, MinorVer), NULL);
}
/**
...
{
  CALL_VOID_BASECRYPTLIB (TlsFree, (Tls));
}
/**
...
{
  return CALL_BASECRYPTLIB (TlsNew, (TlsCtx), NULL);
}
/**
...
{
  return CALL_BASECRYPTLIB (TlsInHandshake, (Tls), FALSE);
}
/**
...
{
  return CALL_BASECRYPTLIB (TlsDoHandshake, (Tls, BufferIn, BufferInSize, BufferOut, BufferOutSize), 0);
}
/**
...
{
  return CALL_BASECRYPTLIB (TlsHandleAlert, (Tls, BufferIn, BufferInSize, BufferOut, BufferOutSize), 0);
}
/**
...
{
  return CALL_BASECRYPTLIB (TlsCloseNotify, (Tls, Buffer, BufferSize), 0);
}
/**
...
{
  return CALL_BASECRYPTLIB (TlsCtrlTrafficOut, (Tls, Buffer, BufferSize), 0);
}
/**
...
{
  return CALL_BASECRYPTLIB (TlsCtrlTrafficIn, (Tls, Buffer, BufferSize), 0);
}
/**
...
{
  return CALL_BASECRYPTLIB (TlsRead, (Tls, Buffer, BufferSize), 0);
}
/**
...
{
  return CALL_BASECRYPTLIB (TlsWrite, (Tls, Buffer, BufferSize), 0);
}
//=============================================================================
//     TLSSET functions
//=============================================================================
...
{
  return CALL_BASECRYPTLIB (TlsSetVersion, (Tls, MajorVer, MinorVer), 0);
}
/**
...
{
  return CALL_BASECRYPTLIB (TlsSetConnectionEnd, (Tls, IsServer), 0);
}
/**
...
{
  return CALL_BASECRYPTLIB (TlsSetCipherList, (Tls, CipherId, CipherNum), 0);
}
/**
...
{
  return CALL_BASECRYPTLIB (TlsSetCompressionMethod, (CompMethod), 0);
}
/**
...
{
  CALL_VOID_BASECRYPTLIB (TlsSetVerify, (Tls, VerifyMode));
}
/**
...
{
  return CALL_BASECRYPTLIB (TlsSetVerifyHost, (Tls, Flags, HostName), 0);
}
/**
...
{
  return CALL_BASECRYPTLIB (TlsSetSessionId, (Tls, SessionId, SessionIdLen), 0);
}
/**
...
{
  return CALL_BASECRYPTLIB (TlsSetCaCertificate, (Tls, Data, DataSize), 0);
}
/**
...
{
  return CALL_BASECRYPTLIB (TlsSetHostPublicCert, (Tls, Data, DataSize), 0);
}
/**
...
{
  return CALL_BASECRYPTLIB (TlsSetHostPrivateKey, (Tls, Data, DataSize), 0);
}
/**
...
{
  return CALL_BASECRYPTLIB (TlsSetCertRevocationList, (Data, DataSize), 0);
}
//=============================================================================
//     TLSGET functions
//=============================================================================
...
{
  return CALL_BASECRYPTLIB (TlsGetVersion, (Tls), 0);
}
/**
...
{
  return CALL_BASECRYPTLIB (TlsGetConnectionEnd, (Tls), 0);
}
/**
...
{
  return CALL_BASECRYPTLIB (TlsGetCurrentCipher, (Tls, CipherId), 0);
}
/**
...
{
  return CALL_BASECRYPTLIB (TlsGetCurrentCompressionId, (Tls, CompressionId), 0);
}
/**
...
{
  return CALL_BASECRYPTLIB (TlsGetVerify, (Tls), 0);
}
/**
...
{
  return CALL_BASECRYPTLIB (TlsGetSessionId, (Tls, SessionId, SessionIdLen), 0);
}
/**
...
{
  CALL_VOID_BASECRYPTLIB (TlsGetClientRandom, (Tls, ClientRandom));
}
/**
...
{
  CALL_VOID_BASECRYPTLIB (TlsGetServerRandom, (Tls, ServerRandom));
}
/**
...
{
  return CALL_BASECRYPTLIB (TlsGetKeyMaterial, (Tls, KeyMaterial), 0);
}
/**
...
{
  return CALL_BASECRYPTLIB (TlsGetCaCertificate, (Tls, Data, DataSize), 0);
}
/**
...
{
  return CALL_BASECRYPTLIB (TlsGetHostPublicCert, (Tls, Data, DataSize), 0);
}
/**
...
{
  return CALL_BASECRYPTLIB (TlsGetHostPrivateKey, (Tls, Data, DataSize), 0);
}
/**
...
{
  return CALL_BASECRYPTLIB (TlsGetCertRevocationList, (Data, DataSize), 0);
}
...
const EDKII_CRYPTO_PROTOCOL mEdkiiCrypto = {
  ...
  CryptoServiceGetCryptoVersion,
  // HMACMD5 functions
  NULL_IF_DISABLED(HmacMd5New),
  NULL_IF_DISABLED(HmacMd5Free),
  NULL_IF_DISABLED(HmacMd5SetKey),
  NULL_IF_DISABLED(HmacMd5Duplicate),
  NULL_IF_DISABLED(HmacMd5Update),
  NULL_IF_DISABLED(HmacMd5Final),
  // HMACSHA1 functions
  NULL_IF_DISABLED(HmacSha1New),
  NULL_IF_DISABLED(HmacSha1Free),
  NULL_IF_DISABLED(HmacSha1SetKey),
  NULL_IF_DISABLED(HmacSha1Duplicate),
  NULL_IF_DISABLED(HmacSha1Update),
  NULL_IF_DISABLED(HmacSha1Final),
  // HMACSHA256 functions
  NULL_IF_DISABLED(HmacSha256New),
  NULL_IF_DISABLED(HmacSha256Free),
  NULL_IF_DISABLED(HmacSha256SetKey),
  NULL_IF_DISABLED(HmacSha256Duplicate),
  NULL_IF_DISABLED(HmacSha256Update),
  NULL_IF_DISABLED(HmacSha256Final),
  // MD4 functions
  NULL_IF_DISABLED(Md4GetContextSize),
  NULL_IF_DISABLED(Md4Init),
  NULL_IF_DISABLED(Md4Duplicate),
  NULL_IF_DISABLED(Md4Update),
  NULL_IF_DISABLED(Md4Final),
  NULL_IF_DISABLED(Md4HashAll),
  // MD5 functions
  NULL_IF_DISABLED(Md5GetContextSize),
  NULL_IF_DISABLED(Md5Init),
  NULL_IF_DISABLED(Md5Duplicate),
  NULL_IF_DISABLED(Md5Update),
  NULL_IF_DISABLED(Md5Final),
  NULL_IF_DISABLED(Md5HashAll),
  // PKCS functions
  NULL_IF_DISABLED(Pkcs5HashPassword),
  NULL_IF_DISABLED(Pkcs1v2Encrypt),
  NULL_IF_DISABLED(Pkcs7GetSigners),
  NULL_IF_DISABLED(Pkcs7FreeSigners),
  NULL_IF_DISABLED(Pkcs7GetCertificatesList),
  NULL_IF_DISABLED(Pkcs7Sign),
  NULL_IF_DISABLED(Pkcs7Verify),
  NULL_IF_DISABLED(VerifyEKUsInPkcs7Signature),
  NULL_IF_DISABLED(Pkcs7GetAttachedContent),
  NULL_IF_DISABLED(AuthenticodeVerify),
  NULL_IF_DISABLED(ImageTimestampVerify),
  // DH functions
  NULL_IF_DISABLED(DhNew),
  NULL_IF_DISABLED(DhFree),
  NULL_IF_DISABLED(DhGenerateParameter),
  NULL_IF_DISABLED(DhSetParameter),
  NULL_IF_DISABLED(DhGenerateKey),
  NULL_IF_DISABLED(DhComputeKey),
  // RANDOM functions
  NULL_IF_DISABLED(RandomSeed),
  NULL_IF_DISABLED(RandomBytes),
  // RSA functions
  NULL_IF_DISABLED(RsaNew),
  NULL_IF_DISABLED(RsaFree),
  NULL_IF_DISABLED(RsaSetKey),
  NULL_IF_DISABLED(RsaGetKey),
  NULL_IF_DISABLED(RsaGenerateKey),
  NULL_IF_DISABLED(RsaCheckKey),
  NULL_IF_DISABLED(RsaPkcs1Sign),
  NULL_IF_DISABLED(RsaPkcs1Verify),
  NULL_IF_DISABLED(RsaGetPrivateKeyFromPem),
  NULL_IF_DISABLED(RsaGetPublicKeyFromX509),
  // SHA1 functions
  NULL_IF_DISABLED(Sha1GetContextSize),
  NULL_IF_DISABLED(Sha1Init),
  NULL_IF_DISABLED(Sha1Duplicate),
  NULL_IF_DISABLED(Sha1Update),
  NULL_IF_DISABLED(Sha1Final),
  NULL_IF_DISABLED(Sha1HashAll),
  // SHA256 functions
  NULL_IF_DISABLED(Sha256GetContextSize),
  NULL_IF_DISABLED(Sha256Init),
  NULL_IF_DISABLED(Sha256Duplicate),
  NULL_IF_DISABLED(Sha256Update),
  NULL_IF_DISABLED(Sha256Final),
  NULL_IF_DISABLED(Sha256HashAll),
  // SHA384 functions
  NULL_IF_DISABLED(Sha384GetContextSize),
  NULL_IF_DISABLED(Sha384Init),
  NULL_IF_DISABLED(Sha384Duplicate),
  NULL_IF_DISABLED(Sha384Update),
  NULL_IF_DISABLED(Sha384Final),
  NULL_IF_DISABLED(Sha384HashAll),
  // SHA512 functions
  NULL_IF_DISABLED(Sha512GetContextSize),
  NULL_IF_DISABLED(Sha512Init),
  NULL_IF_DISABLED(Sha512Duplicate),
  NULL_IF_DISABLED(Sha512Update),
  NULL_IF_DISABLED(Sha512Final),
  NULL_IF_DISABLED(Sha512HashAll),
  // X509 functions
  NULL_IF_DISABLED(X509GetSubjectName),
  NULL_IF_DISABLED(X509GetCommonName),
  NULL_IF_DISABLED(X509GetOrganizationName),
  NULL_IF_DISABLED(X509VerifyCert),
  NULL_IF_DISABLED(X509ConstructCertificate),
  NULL_IF_DISABLED(X509ConstructCertificateStackV),
  NULL_IF_DISABLED(X509ConstructCertificateStack),
  NULL_IF_DISABLED(X509Free),
  NULL_IF_DISABLED(X509StackFree),
  NULL_IF_DISABLED(X509GetTBSCert),
  // TDES functions
  NULL_IF_DISABLED(TdesGetContextSize),
  NULL_IF_DISABLED(TdesInit),
  NULL_IF_DISABLED(TdesEcbEncrypt),
  NULL_IF_DISABLED(TdesEcbDecrypt),
  NULL_IF_DISABLED(TdesCbcEncrypt),
  NULL_IF_DISABLED(TdesCbcDecrypt),
  // AES functions
  NULL_IF_DISABLED(AesGetContextSize),
  NULL_IF_DISABLED(AesInit),
  NULL_IF_DISABLED(AesEcbEncrypt),
  NULL_IF_DISABLED(AesEcbDecrypt),
  NULL_IF_DISABLED(AesCbcEncrypt),
  NULL_IF_DISABLED(AesCbcDecrypt),
  // ARC4 functions
  NULL_IF_DISABLED(Arc4GetContextSize),
  NULL_IF_DISABLED(Arc4Init),
  NULL_IF_DISABLED(Arc4Encrypt),
  NULL_IF_DISABLED(Arc4Decrypt),
  NULL_IF_DISABLED(Arc4Reset),
  // SM3 functions
  NULL_IF_DISABLED(Sm3GetContextSize),
  NULL_IF_DISABLED(Sm3Init),
  NULL_IF_DISABLED(Sm3Duplicate),
  NULL_IF_DISABLED(Sm3Update),
  NULL_IF_DISABLED(Sm3Final),
  NULL_IF_DISABLED(Sm3HashAll),
  // HKDF functions
  NULL_IF_DISABLED(HkdfSha256ExtractAndExpand),
  // TLS functions
  NULL_IF_DISABLED(TlsInitialize),
  NULL_IF_DISABLED(TlsCtxFree),
  NULL_IF_DISABLED(TlsCtxNew),
  NULL_IF_DISABLED(TlsFree),
  NULL_IF_DISABLED(TlsNew),
  NULL_IF_DISABLED(TlsInHandshake),
  NULL_IF_DISABLED(TlsDoHandshake),
  NULL_IF_DISABLED(TlsHandleAlert),
  NULL_IF_DISABLED(TlsCloseNotify),
  NULL_IF_DISABLED(TlsCtrlTrafficOut),
  NULL_IF_DISABLED(TlsCtrlTrafficIn),
  NULL_IF_DISABLED(TlsRead),
  NULL_IF_DISABLED(TlsWrite),
  // TLSSET functions
  NULL_IF_DISABLED(TlsSetVersion),
  NULL_IF_DISABLED(TlsSetConnectionEnd),
  NULL_IF_DISABLED(TlsSetCipherList),
  NULL_IF_DISABLED(TlsSetCompressionMethod),
  NULL_IF_DISABLED(TlsSetVerify),
  NULL_IF_DISABLED(TlsSetVerifyHost),
  NULL_IF_DISABLED(TlsSetSessionId),
  NULL_IF_DISABLED(TlsSetCaCertificate),
  NULL_IF_DISABLED(TlsSetHostPublicCert),
  NULL_IF_DISABLED(TlsSetHostPrivateKey),
  NULL_IF_DISABLED(TlsSetCertRevocationList),
  // TLSGET functions
  NULL_IF_DISABLED(TlsGetVersion),
  NULL_IF_DISABLED(TlsGetConnectionEnd),
  NULL_IF_DISABLED(TlsGetCurrentCipher),
  NULL_IF_DISABLED(TlsGetCurrentCompressionId),
  NULL_IF_DISABLED(TlsGetVerify),
  NULL_IF_DISABLED(TlsGetSessionId),
  NULL_IF_DISABLED(TlsGetClientRandom),
  NULL_IF_DISABLED(TlsGetServerRandom),
  NULL_IF_DISABLED(TlsGetKeyMaterial),
  NULL_IF_DISABLED(TlsGetCaCertificate),
  NULL_IF_DISABLED(TlsGetHostPublicCert),
  NULL_IF_DISABLED(TlsGetHostPrivateKey),
  NULL_IF_DISABLED(TlsGetCertRevocationList),
};
// MU_CHANGE END