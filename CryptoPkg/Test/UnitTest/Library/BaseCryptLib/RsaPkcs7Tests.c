  ...
  )
{
  ...
  UT_ASSERT_EQUAL (CommonNameSize, 7);
  UT_ASSERT_MEM_EQUAL (CommonName, "Client", 7);
  ...
  UT_ASSERT_EQUAL (OrgNameSize, 6);
  DEBUG(( DEBUG_INFO, "ORGNAME: %a\n", OrgName));
  UT_ASSERT_MEM_EQUAL (OrgName, "INTEL", 6);
