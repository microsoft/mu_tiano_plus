...
//HMAC_TEST_CONTEXT       mHmacMd5TestCtx    = {MD5_DIGEST_SIZE,    HmacMd5New,    HmacMd5SetKey,    HmacMd5Update,    HmacMd5Final,  HmacShaMd5Free, HmacMd5Key,    sizeof(HmacMd5Key),    HmacMd5Digest};
//HMAC_TEST_CONTEXT       mHmacSha1TestCtx   = {SHA1_DIGEST_SIZE,   HmacSha1New,   HmacSha1SetKey,   HmacSha1Update,   HmacSha1Final, HmacSha1Free,   HmacSha1Key,   sizeof(HmacSha1Key),   HmacSha1Digest};
HMAC_TEST_CONTEXT       mHmacSha256TestCtx = {SHA256_DIGEST_SIZE, HmacSha256New, HmacSha256SetKey, HmacSha256Update, HmacSha256Final, HmacSha256Free, HmacSha256Key, sizeof(HmacSha256Key), HmacSha256Digest};
  ...
  )
{
  ...
  HmacTestContext = Context;
  if (HmacTestContext->HmacCtx != NULL && HmacTestContext->HmacFree != NULL) {
