...
HASH_TEST_CONTEXT       mMd4TestCtx    = {MD4_DIGEST_SIZE,    Md4GetContextSize,    Md4Init,    Md4Update,    Md4Final,    Md4HashAll,    Md4Digest};
...
TEST_DESC mHashTest[] = {
    ...
    //
    {"TestVerifyMd4()",    "CryptoPkg.BaseCryptLib.Hash",   TestVerifyHash, TestVerifyHashPreReq, TestVerifyHashCleanUp, &mMd4TestCtx},
