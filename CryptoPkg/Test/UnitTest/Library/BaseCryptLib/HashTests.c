...
//HASH_TEST_CONTEXT       mMd5TestCtx    = {MD5_DIGEST_SIZE,    Md5GetContextSize,    Md5Init,    Md5Update,    Md5Final,    Md5HashAll,    Md5Digest}; // MU_CHANGE turn off MD5 as that is null for MU
...
TEST_DESC mHashTest[] = {
    ...
    //
    // {"TestVerifyMd5()",    "CryptoPkg.BaseCryptLib.Hash",   TestVerifyHash, TestVerifyHashPreReq, TestVerifyHashCleanUp, &mMd5TestCtx}, //MU_CHANGE disable MD5 test as that is unsupported on Mu
