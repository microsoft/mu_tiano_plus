...
/// IMPORTANT!
///
/// The following macros are temporarily defined in release/202002 for
/// backward compatibility. All code should move to use the new define
/// macros LAST_ATTEMPT_STATUS_DEVICE_LIBRARY_MIN_ERROR_CODE_VALUE and
