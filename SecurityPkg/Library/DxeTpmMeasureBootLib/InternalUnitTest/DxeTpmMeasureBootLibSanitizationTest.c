...
/**
  This function tests the TpmSanitizeEfiPartitionTableHeader function.
...
/**
  This function tests the TpmSanitizePrimaryHeaderAllocationSize function.
...
/**
  This function tests the TpmSanitizePrimaryHeaderGptEventSize function.
...
/**
  This function tests the TpmSanitizePeImageEventSize function.
  ...
  )
{
  ...
  if (EFI_ERROR (Status)) {
    UT_LOG_ERROR ("TpmSanitizePeImageEventSize failed with %r\n", Status);
    goto Exit;
  }
  ...
  if (EventSize != ExistingLogicEventSize) {
    UT_LOG_ERROR ("TpmSanitizePeImageEventSize returned an incorrect event size. Expected %u, got %u\n", ExistingLogicEventSize, EventSize);
    goto Exit;
  }
