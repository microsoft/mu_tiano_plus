...
/**
  This function tests the Tpm2SanitizeEfiPartitionTableHeader function.
...
/**
  This function tests the Tpm2SanitizePrimaryHeaderAllocationSize function.
...
/**
  This function tests the Tpm2SanitizePrimaryHeaderGptEventSize function.
...
/**
  This function tests the Tpm2SanitizePeImageEventSize function.
  ...
  )
{
  ...
  if (EventSize != ExistingLogicEventSize) {
    UT_LOG_ERROR ("Tpm2SanitizePeImageEventSize returned an incorrect event size. Expected %u, got %u\n", ExistingLogicEventSize, EventSize);
